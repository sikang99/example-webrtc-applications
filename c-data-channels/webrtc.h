...
extern void GoRun(GoOnDataChannelFunc p0);

extern void GoOnOpen(GoDataChannel p0, GoOnOpenFunc p1);

extern void GoOnMessage(GoDataChannel p0, GoOnMessageFunc p1);

extern void GoSendText(GoDataChannel p0, char* p1);

extern char* GoLabel(GoDataChannel p0);
